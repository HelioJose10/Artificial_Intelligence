...
DROP TABLE IF EXISTS hashsA;
DROP TABLE IF EXISTS updatesA;
DROP TABLE IF EXISTS bcfilesContentA;
DROP TABLE IF EXISTS bchashsA;
DROP TABLE IF EXISTS bcupdatesA;
